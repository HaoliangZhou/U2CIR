    ...
    for iteration , task_i in enumerate(config['task']):
        ...
        for epoch in range(0, config['max_epoch']):
            ...
            if utils.is_main_process():
                ...
                crossmodal_dict[iteration] = '{:.2f}, {:.2f}, {:.2f}, {:.2f}, {:.2f}'.format(f_r1, f_r5, f_r10,f_r50, f_rmean, f_rsum)
        ...
        if utils.is_main_process():  
            ...
            log_stats = {**{f'train_{k}': v for k, v in train_stats.items()},
                    **{f'test_{k}': v for k, v in test_result.items()},
                    'task': task_i,
                    'iteration': iteration,
                    'R@1,R@5,R@10,R@50,R_mean': '{:.2f}/{:.2f}/{:.2f}/{:.2f}/{:.2f}/{:.2f}'.format(f_r1, f_r5, f_r10,f_r50, f_rmean, f_rsum),
            }
            save_model_name = {
